...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/sis/public/storage' => 'string',
...
'filesystems.links./var/www/sis/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'user.store','user.show','user.update','user.destroy','subjects.index',
'subjects.store','subjects.show','subjects.update','subjects.destroy','role.index',
'role.store','role.show','role.update','role.destroy','permission.index',
'permission.store','permission.show','permission.update','permission.destroy','/','student.register','student.checkUniqueField',
'otp.send','otp.verify','otp.reset','login',
'password.request','password.process','password.reset','password.update','logout',
'dashboard','subjects.index','subjects.create','subjects.store','subjects.show',
'subjects.edit','subjects.update','subjects.destroy','storage.local',);
        registerArgumentsSet('views', 
'admin.dashboard','admin.subject.subject','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','layouts.app','layouts.auth','mail.auth.reset-password','mail.layouts.app',
'partials._flash','partials.admin.navbar','partials.admin.preloader','partials.admin.scripts','partials.admin.sidebarchat',
'partials.admin.styles','partials.admin.topbar','partials.auth._background','partials.auth._floating-nav','partials.auth._footer',
'partials.auth._mobile-nav','register','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','AUTH_GUARD',);
