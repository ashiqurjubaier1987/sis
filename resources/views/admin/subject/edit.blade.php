                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="attendance_device_id" id="attendance_device_id"
                                        ...
                                        placeholder="e.g. 101"
                                        value="{{ old('attendance_device_id', $subject->attendance_device_id) }}">
                                        ...
                                        <div class="checkbox-fade fade-in-primary m-b-10">
                                            <label>
                                                <input type="checkbox" name="sms_enroll_student" value="1"
                                                    {{ old('sms_enroll_student', $subject->sms_enroll_student) ? 'checked' : '' }}>
                                                <span class="cr">
                                        ...
                                        <div class="checkbox-fade fade-in-primary m-b-10">
                                            <label>
                                                <input type="checkbox" name="notify_teacher_enroll" value="1"
                                                    {{ old('notify_teacher_enroll', $subject->notify_teacher_enroll) ? 'checked' : '' }}>
                                                <span class="cr">
                                                    <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                                                </span>
                                        ...
                                        <div class="checkbox-fade fade-in-primary">
                                            <label>
                                                <input type="checkbox" name="notify_teacher_zero_fee" value="1"
                                                    {{ old('notify_teacher_zero_fee', $subject->notify_teacher_zero_fee) ? 'checked' : '' }}>
                                                <span class="cr">
                                                    <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                                                </span>
