            ...
            <div class="card bg-c-yellow update-card">
                <div class="card-block">
                    <div class="row align-items-end">
                        <div class="col-8">
                            {{-- <h4 class="text-white">{{ floor($sms_balance->response) }}</h4> --}}
                            <h4 class="text-white">10</h4>
                            <h6 class="text-white m-b-0">SMS Credit Balance</h6>
                        </div>
                        <div class="col-4 text-right">
                            <i class="icofont icofont-ui-message icofont-4x"></i>
                            <!-- <canvas id="update-chart-1" height="50"></canvas> -->
                        </div>
                    </div>
                </div>
                <div class="card-footer">
                    <p class="text-white m-b-0"><i class="feather icon-clock text-white f-14 m-r-10"></i>update : {{ now()->format('g:i A') }}</p>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="card bg-c-green update-card">
                <div class="card-block">
                    <div class="row align-items-end">
                        <div class="col-8">
                            {{-- <h4 class="text-white">{{ceil($dashboard_data->current_month_sms_cost)}}</h4> --}}
                            <h4 class="text-white">10</h4>
                            <h6 class="text-white m-b-0">Current Month SMS Cost</h6>
                        </div>
                        <div class="col-4 text-right">
                            <i class="icofont icofont-ui-chat icofont-4x"></i>
                        </div>
                    </div>
                </div>
                <div class="card-footer">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-c-pink update-card">
                <div class="card-block">
                    <div class="row align-items-end">
                        <div class="col-8">
                            {{-- <h4 class="text-white">{{$dashboard_data->today_earning}}</h4> --}}
                            <h4 class="text-white">10000</h4>
                            <h6 class="text-white m-b-0">Today's Earning</h6>
                        </div>
                        <div class="col-4 text-right">
                            <i class="icofont icofont-money icofont-4x"></i>
                        </div>
                    </div>
                </div>
                <div class="card-footer">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-c-lite-green update-card">
                <div class="card-block">
                    <div class="row align-items-end">
                        <div class="col-8">
                            {{-- <h4 class="text-white">{{$dashboard_data->new_student_registration}}</h4> --}}
                            <h4 class="text-white">20</h4>
                            <h6 class="text-white m-b-0">New Student Registered</h6>
                        </div>
                        <div class="col-4 text-right">
                           <i class="icofont icofont-users-alt-3 icofont-4x"></i>
                        </div>
                    </div>
                </div>
                <div class="card-footer">
                ...
                <div class="card-block">
                    <div class="row m-b-25">
                        <div class="col-auto p-r-0">
                            <div class="u-img">
                                <img src={{asset('adminend/images/breadcrumb-bg.jpg')}} alt="user image" class="img-radius cover-img">
                                <img src={{asset('adminend/images/avatar-2.jpg')}} alt="user image" class="img-radius profile-img">
                            </div>
                        </div>
                        <div class="col">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="b-none">
                                                    ...
                                                    <img src={{asset('adminend/images/avatar-2.jpg')}} alt="user image" class="img-radius img-40 align-top m-r-15">
                ...
                <div class="row m-l-0 m-r-0">
                    <div class="col-sm-4 bg-c-lite-green user-profile">
                        <div class="card-block text-center text-white">
                            <div class="m-b-25">
                                <!-- <img src={{asset('adminend/images/avatar-4.jpg" ')}}lass="img-radius" alt="User-Profile-Image"> -->
                            </div>
