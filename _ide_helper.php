...
namespace Illuminate\Support\Facades {
    ...
    class Response {
         ...
         * @static
         */
        public static function api($data = null, $message = 'Success', $status = 200, $success = true, $errors = null)
        {
            return \Illuminate\Routing\ResponseFactory::api($data, $message, $status, $success, $errors);
        }
